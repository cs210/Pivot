...
## Features Overview
### Web Portal
We created a web portal for users to upload their videos, which includes authentication, AWS S3 storage for the videos, and other features documented in the github issues.
