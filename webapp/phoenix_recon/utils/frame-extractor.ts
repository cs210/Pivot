export interface ExtractedFrame {
  dataUrl: string;
  timestamp: number;
  // CHANGED index to be index? (i.e. optional) to preserve compatability with `panorama-viewer.tsx` line 137-143
  index?: number;
  // ADDED filename, size, and type to preserve compatability with `panorama-viewer.tsx` line 137-143
  fileName?: string;
  size?: number;
  type?: string;
}
