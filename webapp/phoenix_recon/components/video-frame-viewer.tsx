...
import EnhancedPanoramaViewer from "@/components/panorama-viewer";
import {
  extractSparseFrames,
  type ExtractedFrame,
  formatTimestamp,
...
export default function VideoFrameViewer({
  ...
  const goToNextFrame = () => {
    ...
    setCurrentFrameIndex(
      (prevIndex) => (prevIndex + 1) % extractedFrames.length
    );
  };
  ...
  const goToPreviousFrame = () => {
    ...
    setCurrentFrameIndex((prevIndex) =>
      prevIndex === 0 ? extractedFrames.length - 1 : prevIndex - 1
    );
  };
          ...
          <Card className="bg-background/80 backdrop-blur-sm border-border/50">
            <CardContent className="p-4 space-y-4">
              <h3 className="text-lg font-medium">
                Extract Frames for 360° View
              </h3>
              <p className="text-sm text-muted-foreground">
                Extract frames from this video to view in 360° mode. Adjust the
          ...
          {extractedFrames.length === 0 ? (
            <div className="text-center py-12">
              <p className="text-muted-foreground mb-4">
                No frames have been extracted yet. Go to the Video tab to
                extract frames.
              </p>
              <Button
            ...
            <>
              ...
              <div className="p-4 bg-background/80 backdrop-blur-sm rounded-lg border border-border/50">
                <h3 className="text-lg font-medium mb-2">
                  360° Navigation Instructions
                </h3>
                <ul className="text-sm text-muted-foreground space-y-1">
                  <li>• Click and drag to look around in 360°</li>
                  <li>
                    • Use the timeline or arrow buttons to move between frames
                  </li>
