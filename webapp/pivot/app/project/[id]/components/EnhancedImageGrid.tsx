            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <div className="flex items-center space-x-2">
                <div className="flex flex-col items-center">
                  <span className="text-sm font-medium mb-1">Rows: {rows}</span>
              ...
              <div className="flex items-center space-x-2">
                <div className="flex flex-col items-center">
                  <span className="text-sm font-medium mb-1">Columns: {cols}</span>
                  <div className="flex items-center">
                    <Button 
                    ...
                    Array.from({ length: cols }).map((_, x) => {
                      ...
                      return (
                        <div key={posKey} className="relative">
                          <div
                            className={`w-32 h-32 rounded-full relative flex items-center justify-center border-2 transition-all cursor-pointer ${
                              panorama
                          ...
                          {/* Dropdown for panorama selection */}
                          {openDropdownCell === posKey && (
                            <div
                                ...
                                <ul className="space-y-2 mt-2">
                                  {unassignedPanoramas.map((pano) => (
                                    <li
                                      ...
                                      onClick={() => handleAssignPanorama(x, y, pano.id)}
                                    >
