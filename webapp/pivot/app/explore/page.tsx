      ...
      <div className="flex flex-col min-h-screen">
        ...
        <main className="flex-1 container mx-auto p-8">
          <Alert className="mb-8">
            ...
            <AlertDescription>
              Sorry, your email domain doesn&apos;t have access to any
              organizations in our system. Currently, we only support Stanford
              University (stanford.edu email addresses).
            </AlertDescription>
          </Alert>
            ...
            {filteredProjects.length === 0 ? (
              <div className="text-center p-12 border rounded-lg">
                ...
                <p className="text-gray-500 mt-2">
                  Try adjusting your filters or go to your dashboard to create
